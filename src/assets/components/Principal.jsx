    ...
    <div className=' m-2 xl:flex xl:max-w-full xl:justify-between md:flex justify-between xl:m-20 max-w-full  gap-7 md:m-5'>
        ...
        <section className=' xl:max-w-[70rem] mt-10 m-5  w-full' >
                ...
                <div className=' xl:mx-auto xl:mt-8 xl:mb-8 mt-5 mb-5 '>
                    <div className=' flex justify-between w-full xl:flex xl:justify-between items-center gap-2 lg:justify-between xl:items-center xl:gap-6 md:w-full xl:relative md:flex md:justify-between md:relative md:gap-1 md:items-center md:mt-3 md:mb-3'>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <img className="cursor-pointer w-6 h-6" src={Norows} alt="Ver" />
                            <img className="cursor-pointer w-6 h-6" src={Tworows} alt="Ver" />
                        </div>
                    </div>
                </div>
            ...
            <div className="lg:grid lg:grid-cols-2 m-10 ml-0">
                <div data-aos="fade-down-right" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className=' w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={Tesla} alt="Tesla Car" />
                    </div>
                    ...
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        ...
                        <h4>SFM, DO</h4>
                        <div className=" lg:flex lg:text-[1rem]  md:grid md:grid-cols-2 grid grid-cols-2 justify-between gap-6">
                ...
                <div data-aos="fade-up-left" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className=' image w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={Ford} alt="Ford F-250 Super Duty" />
                    </div>
                    <button className=' absolute -rotate-[40deg] top-5 -left-10 border bg-blue-500 py-1 w-40'>Destacado</button>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        <button className="border border-blue-500 text-blue-500 px-5" >Nuevo</button>
                ...
                <div data-aos="flip-up" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className=' w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={Honda} alt="Honda Pilot Touring 7-Passenger" />
                    </div>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        <button className="border border-blue-500 text-blue-500 px-5" >Nuevo</button>
                ...
                <div data-aos="flip-up" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className=' w-full h-full lg:w-full lg:h-full  xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={Jeep} alt="Jeep Wrangler Unlimited Islander" />
                    </div>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                ...
                <div data-aos="flip-down" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className=' w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={Chevrolet} alt="Chevrolet Equinox LS" />
                    </div>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        <button className="border border-blue-500 text-blue-500 px-5" >Nuevo</button>
                ...
                <div data-aos="flip-down" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className=' image w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={Audi} alt="Audi e-tron Premium" />
                    </div>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        <button className="border border-blue-500 text-blue-500 px-5" >Usado</button>
                        <h2 className="text-[2rem] md:text-[1.2rem]" >Audi e-tron Premium</h2>
                        <span className="text-blue-500 text-[1.5rem]">$72,655</span>
                        <h4>SFM, DO</h4>
                        <div className=" lg:flex  md:grid md:grid-cols-2 grid grid-cols-2 justify-between gap-4">
                            <div className=' lg:flex gap-1 md:flex items-center flex'>
                                <img className="w-5 h-5" src={Calender} alt="Calendario" />
                ...
                <div data-aos="zoom-in-down" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className=' w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={Kia} alt="Kia Sorento S" />
                    </div>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        <button className="border border-blue-500 text-blue-500 px-5" >Nuevo</button>
                ...
                <div data-aos="zoom-in-down" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className=' w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={coupe} alt="MINI Clubman Cooper S" />
                    </div>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        <button className="border border-blue-500 text-blue-500 px-5" >Nuevo</button>
                ...
                <div data-aos="fade-up" className='border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className='overflow-hidden xl:w-full'>
                        <img className=' w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={LandRover} alt="Land Rover Range Rover Velar R-Dynamic S" />
                    </div>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        <button className="border border-blue-500 text-blue-500 px-5" >Usado</button>
                        <h2 className="text-[2rem] md:text-[1.2rem]" >Land Rover Range Rover Velar R-Dynamic S</h2>
                ...
                <div data-aos="fade-up" className='  border border-solid  border-gray-700 lg:max-w-9xl xl: lg:flex lg:flex-col  relative xl:items-center gap-4 mb-20 xl:relative overflow-hidden md:py-3 md:px-3' >
                    <div className=' overflow-hidden xl:w-full'>
                        <img className='  w-full h-full lg:w-full lg:h-full xl:bg-gray-200 xl:w-full hover:scale-150 transition-all ease-linear cursor-pointer md:w-full' src={Toyota} alt="Toyota Mirai Limited" />
                    </div>
                    <div className=' xl:w-full md:mt-3 mt-5 xl:mt-0 lg:m-1 px-2 py-2'>
                        <button className="border border-blue-500 text-blue-500 px-5" >Usado</button>
                        <h2 className="text-[2rem] md:text-[1.2rem]" >Toyota Mirai Limited</h2>
