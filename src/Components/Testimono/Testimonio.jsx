...
const Testimonio = () => {
    ...
    return (
        <div className="bg-transparentflex flex-col mt-10 p-32 bg-[#0B0C10]">
            <div className="bg-transparent self-start text-2xl font-bold text-zinc-300 max-md:ml-1">
                Testimonio
            </div>

            <div className="bg-transparent overflow-hidden px-8 pt-20 pb-9  mt-4 w-full fill-slate-900 max-md:px-5 max-md:max-w-full">
                <div className="bg-transparent flex gap-5 max-md:flex-col max-md:gap-0">
                    ...
                    <div className="bg-transparent flex flex-col ml-5 w-[58%] max-md:ml-0 max-md:w-full">
                        <div className="bg-transparent flex flex-col mt-1.5 text-lg text-sky-600 max-md:mt-10 max-md:max-w-full">
                            ...
                            <div className="bg-transparent mt-8 font-semibold text-zinc-300 max-md:max-w-full">
