...
function Header({background}) {
  ...
  return (
    ...
    <div className='md:py-28 md:px-12 bg-black text-white px-10 py-10'>
          <h1 className='md:text-[3rem] text-[1.9rem] bg-transparent'>Lorem Lesum</h1>
          <h3 className='md:text-[2rem] bg-transparent'>Homepage - Lorem Lesum</h3>
    </div>
</nav>
  )
}
