<<<<<<<< HEAD:src/Layout/Screens/NewCar/components/Header.jsx
...
function Header() {
>>>>>>>> d3cc65502def1159c440f87ebaa259ab2555efd7:src/Layout/SearchResultOne/components/Header.jsx
  return (
...
<<<<<<<< HEAD:src/Layout/Screens/NewCar/components/Header.jsx
        <div className=' md:m-28 bg-transparent m-10'>
          <h1 className='text-[3rem] bg-transparent'>Autos Nuevos</h1>
          <h3 className='text-[2rem] bg-transparent'>Homepage - Autos Nuevos</h3>
========
